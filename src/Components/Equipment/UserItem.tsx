...
const caseRegex = /case|capsule/i;
  ...
  return (
    <div>
      ...
      <div
        ...
        onClick={() =>
          dispatch(isSelected ? removeFromPickedItems(market_name) : addToPickedItems({ market_name, item }))
        }
      >
        <div className="item-image-wrapper">
          <img src={`https://steamcommunity-a.akamaihd.net/economy/image//${icon_url}`} className="item-image" />
        </div>
